  ...
  return (
    <div>
      ...
      <main className={styles.main}>
        <div className={styles.contentInsurancePg}>
          ...
          <h5 className={styles.secondInsurancesDetail}>You can get the tranches, the payouts and check the status of the protocol in the Protocol page. You can vary your risk exposure by swapping your SafeBet or your BearerOfAll tokens for the other, BearerOfAll or SafeBet respectively.</h5>
